...
GF.screens['pt-profile']=function(){document.getElementById('main-content').innerHTML=`${GF.screenHeader('Hồ sơ huấn luyện viên','Thông tin chuyên môn và cài đặt tài khoản','<button class="btn btn-primary" onclick="GF.toast.success(\'Đã lưu hồ sơ huấn luyện viên\')"><i class="bi bi-check2"></i>Lưu thay đổi</button>')}<div class="row g-4"><div class="col-lg-4"><div class="card p-4 text-center">${GF.renderAvatar(PT_NAME,96)}<h3 class="mt-3" style="font-size:20px">${PT_NAME}</h3><p>NV005 · Huấn luyện viên cá nhân</p><div class="d-flex justify-content-center gap-2 mt-3"><span class="badge bg-warning-subtle text-warning"><i class="bi bi-star-fill"></i>4,9/5</span><span class="badge bg-success-subtle text-success">Đang hoạt động</span></div><div class="divider"></div><div class="row"><div class="col-6"><strong class="text-xl">126</strong><p class="text-xs">Buổi đã dạy</p></div><div class="col-6"><strong class="text-xl">12</strong><p class="text-xs">Hội viên</p></div></div><button class="btn btn-outline-primary w-full mt-3"><i class="bi bi-camera"></i>Đổi ảnh đại diện</button></div></div><div class="col-lg-8"><div class="card"><div class="card-header"><h5>Thông tin cá nhân</h5></div><div class="card-body"><div class="row"><div class="col-6"><label class="form-label">Họ và tên</label><input class="form-control" value="Phạm Minh Tuấn"></div><div class="col-6"><label class="form-label">Số điện thoại</label><input class="form-control" value="0987 442 136"></div><div class="col-12"><label class="form-label">Email</label><input class="form-control" value="tuan.pham@gymflow.vn"></div><div class="col-12"><label class="form-label">Chuyên môn</label><input class="form-control" value="Tăng cơ, sức mạnh, phục hồi vận động"></div><div class="col-12"><label class="form-label">Giới thiệu</label><textarea class="form-control" rows="3">Huấn luyện viên với 6 năm kinh nghiệm, chuyên xây dựng chương trình tăng cơ và cải thiện sức mạnh an toàn.</textarea></div><div class="col-6"><label class="form-label">Chứng chỉ</label><input class="form-control" value="ACE-CPT, NASM-CES"></div><div class="col-6"><label class="form-label">Kinh nghiệm</label><input class="form-control" value="6 năm"></div></div></div></div><div class="card mt-4"><div class="card-header"><h5>Lịch làm việc mặc định</h5></div><div class="card-body"><div class="d-flex gap-2 flex-wrap">${['Thứ 2 · 08:00–18:00','Thứ 3 · 08:00–18:00','Thứ 4 · Nghỉ','Thứ 5 · 08:00–18:00','Thứ 6 · 08:00–18:00','Thứ 7 · 08:00–12:00'].map(x=>`<span class="badge bg-primary-subtle text-blue" style="padding:8px 12px">${x}</span>`).join('')}</div></div></div></div></div>`};
